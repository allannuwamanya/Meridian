  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between">
        <div>
          <h2 className="text-xl font-bold text-white mb-1">Awards & Honors</h2>
          <p className="text-sm text-slate-500">Recognition that separates you from equally qualified candidates.</p>
        </div>
      ...
      <AnimatePresence>
        {resume.awards.length === 0 && (
          ...
          >
            ...
            <p className="text-sm text-slate-500 mb-1">No awards added yet</p>
            <p className="text-xs text-slate-600">Include hackathon wins, academic honors, or industry recognition.</p>
          </motion.div>
        )}
      </AnimatePresence>
